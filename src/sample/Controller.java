    ...
    private void equalMethod() {
        ...
        switch (this.operation) {
            case '+':
                ...
                break;
            case '-': res=this.first_num-Float.parseFloat(this.str_num);
                break;
            case '/':if(Integer.parseInt(this.str_num) !=0)
                res=this.first_num/Float.parseFloat(this.str_num);
            else res=0;
                break;
            case '*': res=this.first_num*Float.parseFloat(this.str_num);
